...
//	ulPhy->SetHarqPhyModule (harq);
	...
	// Carlos modification for beam management
	Ptr<MmWaveBeamManagement> manager = CreateObject<MmWaveBeamManagement>();
...
MmWaveHelper::InstallSingleEnbDevice (Ptr<Node> n)
{
	...
	Ptr<MmWavePhyMacCommon> phyMacCommon = Copy<MmWavePhyMacCommon>(m_phyMacCommon); // Carlos modification
	phyMacCommon->SetPeriodicCsiResourcePeriodicity(m_beamReportingPeriodicity);
...
//	ulPhy->SetHarqPhyModule (harq);
	...
	*/
	...
	Ptr<MmWaveFlexTtiMacScheduler> ttiSched = DynamicCast<MmWaveFlexTtiMacScheduler>(sched);
	ttiSched->SetBeamManager(manager);
	// End of modification
...
void MmWaveHelper::SetBeamReportingPeriod (MmWavePhyMacCommon::CsiReportingPeriod period)
{
	m_beamReportingPeriodicity = period;
	m_csiResourcePeriodicity = period;
}

MmWavePhyMacCommon::CsiReportingPeriod MmWaveHelper::GetBeamReportingPeriod ()
{
	return m_beamReportingPeriodicity;
}

void MmWaveHelper::SetCsiResourceAllocationPeriod (MmWavePhyMacCommon::CsiReportingPeriod period)
{
	m_csiResourcePeriodicity = period;
}

MmWavePhyMacCommon::CsiReportingPeriod MmWaveHelper::GetCsiResourceAllocationPeriod ()
{
	return m_csiResourcePeriodicity;
}
