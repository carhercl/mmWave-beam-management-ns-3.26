...
main (int argc, char *argv[])
{
  ...
  // LogComponentEnable("TcpSocketBase", LOG_LEVEL_INFO);
	...
	bool csiEnabled = true;
	std::string stringCsiPeriodicity = "ms10";
	MmWavePhyMacCommon::CsiReportingPeriod csiPeriodicity = MmWavePhyMacCommon::CsiReportingPeriod::ms10;
...
//	cmd.AddValue("interPacketInterval", "Inter-packet interval [us])", interPacketInterval);
	...
	cmd.AddValue("csi","Use of periodic CSI-RS resources for beam tracking",csiEnabled);
	cmd.AddValue("csiPeriodicity", "Periodic CSI-RS resources periodicity", stringCsiPeriodicity);
...
//		std::cout << "Digital architecture" << std::endl;
	...
	// Periodic CSI-RS value
	if (stringCsiPeriodicity == "ms0")
	{
		//csiPeriodicity = MmWavePhyMacCommon::CsiReportingPeriod::ms10;
		csiEnabled = false;
	}
	if (stringCsiPeriodicity == "ms10")
	{
		csiPeriodicity = MmWavePhyMacCommon::CsiReportingPeriod::ms10;
	}
	else if (stringCsiPeriodicity == "ms20")
	{
		csiPeriodicity = MmWavePhyMacCommon::CsiReportingPeriod::ms20;
	}
	else if (stringCsiPeriodicity == "ms40")
	{
		csiPeriodicity = MmWavePhyMacCommon::CsiReportingPeriod::ms40;
	}
	else if (stringCsiPeriodicity == "ms80")
	{
		csiPeriodicity = MmWavePhyMacCommon::CsiReportingPeriod::ms80;
	}
	else
	{
		NS_LOG_ERROR("Unsupported or unrecognized value for periodic CSI-RS allocation and reporting value. Choose among ms10, ms20, ms40, ms80");
	}
  ...
  // Set CSI-RS / beam report periodicity
  mmwaveHelper->SetPeriodicCsiReportingConditionFlag(csiEnabled);
  mmwaveHelper->SetBeamReportingPeriod(csiPeriodicity);
//  std::cout << "Periodic CSI reporting status = " << csiEnabled << ". Period value = " << stringCsiPeriodicity << std::endl;
